...
If this parameter is missing, events are fetched starting with the oldest.
...
If this parameter is missing, events are fetched starting with StartTime to the most recent.
